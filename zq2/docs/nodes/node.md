...
> **Temporary Testnet Fork Specification**
> 
> For the Testnet, there are temporary fork heights (9494740 and 9498974) related to the `evm_exec_failure_causes_scilla_precompile_to_fail` parameter. Smart contract developers should be aware of these specific block heights and their impact on Scilla VM behavior. Ensure your node is updated before these block heights to maintain proper synchronization and contract execution.
