...
The activation of the `deposit_v7` contract upgrade on the ZQ2 testnet has been postponed. The new activation block height is `17010000`.

Additionally, the `withdrawal_period` for the testnet will be updated to `461680` blocks. Please ensure your node is updated to reflect these changes to avoid any synchronization issues.
:::
